...
class UiPreference(QMainWindow, Ui_preference.Ui_Preference):
    def __init__(self, parent=None):
        ...
        self.baiduLink.setText(
            "<a href='https://github.com/KaleW515/fast-translate/blob/main/docs/百度翻译.md'>如何获取</a>")
        self.googleLink.setOpenExternalLinks(True)
        self.googleLink.setText(
            "<a href='https://github.com/KaleW515/fast-translate/blob/main/docs/谷歌翻译.md'>如何填写</a>")
